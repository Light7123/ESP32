...
extern const uint8_t cert_sfh_start[] asm("_binary_chart_html_start");
extern const uint8_t cert_sfh_end[] asm("_binary_chart_html_end");
...
static httpd_uri_t chart = {
    .uri = "/chart",
    .method = HTTP_GET,
    .handler = chart_get_handler,
    /* Let's pass response string in user
     * context to demonstrate it's usage */
    .user_ctx = cert_sfh_start};
